...
var external_react_simple_maps_ = __webpack_require__("jBo5");
...
function (_Component) {
  ...
  function BasicMap() {
    ...
    return _possibleConstructorReturn(this, getPrototypeOf_getPrototypeOf(BasicMap).apply(this, arguments));
  }

  _createClass(BasicMap, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      fetch("https://restcountries.eu/rest/v2/name/united").then(function (res) {
        return res.json();
      ...
      setTimeout(function () {
        external_react_tooltip_default.a.rebuild();
      }, 100);
    }
  }, {
    key: "render",
    value: function render() {
      return external_react_default.a.createElement("div", {
        style: wrapperStyles
      }, external_react_default.a.createElement(external_react_simple_maps_["ComposableMap"], {
        projectionConfig: {
          scale: 205
        },
        width: 980,
      ...
      }, external_react_default.a.createElement(external_react_simple_maps_["ZoomableGroup"], {
        center: [0, 20],
        disablePanning: true
      }, external_react_default.a.createElement(external_react_simple_maps_["Geographies"], {
        geography: "/static/world-50m.json"
      }, function (geographies, projection) {
        return geographies.map(function (geography, i) {
          return geography.id !== "ATA" && external_react_default.a.createElement(external_react_simple_maps_["Geography"], {
            key: i,
      ...
      }))), external_react_default.a.createElement(external_react_tooltip_default.a, null));
    }
  }]);
...
/* harmony default export */ var pages = __webpack_exports__["default"] = (pages_BasicMap);
